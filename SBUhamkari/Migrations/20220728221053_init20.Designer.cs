...
namespace SBUhamkari.Migrations
{
    ...
    [Migration("20220728221053_init20")]
            ...
            modelBuilder.Entity("Models.Models.EducationInstitute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("c0393ec9-0017-4be6-a555-7b950d373f62"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 40, 52, 471, DateTimeKind.Local).AddTicks(7352),
                            Name = "SBU"
                        },
                        new
                        {
                            id = new Guid("c0a92c6b-73ad-4af7-95af-b6fcb4856954"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 40, 52, 471, DateTimeKind.Local).AddTicks(7418),
                            Name = "PNU"
                        });
                });
            ...
            modelBuilder.Entity("Models.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("b2ea2d4c-26c4-47f7-bac4-db3b17d270b7"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 40, 52, 471, DateTimeKind.Local).AddTicks(7481),
                            Name = "Admin"
                        },
                        new
                        {
                            id = new Guid("b65f157d-0bc7-40b3-8705-69cba080d551"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 40, 52, 471, DateTimeKind.Local).AddTicks(7490),
                            Name = "Student"
                        },
                        new
                        {
                            id = new Guid("3ddb50b0-1efe-46ab-8c6e-009ac90effc7"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 40, 52, 471, DateTimeKind.Local).AddTicks(7495),
                            Name = "teacher"
                        },
                        new
                        {
                            id = new Guid("fbcd3639-48af-4a09-bfa0-d763e10d5f55"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 40, 52, 471, DateTimeKind.Local).AddTicks(7535),
                            Name = "Company"
                        });
                });
