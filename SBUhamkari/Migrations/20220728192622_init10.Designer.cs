...
namespace SBUhamkari.Migrations
{
    ...
    [Migration("20220728192622_init10")]
            ...
            modelBuilder.Entity("Models.Models.EducationInstitute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("dec05e9e-7e29-4f04-9f38-37716f9a1a84"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5320),
                            Name = "SBU"
                        },
                        new
                        {
                            id = new Guid("71281c25-7197-471d-ba16-cc350091a55a"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5388),
                            Name = "PNU"
                        });
                });
            ...
            modelBuilder.Entity("Models.Models.WorkField", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("5f92b8c4-a65c-49d9-880f-c15d0324b3a4"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5879),
                            Name = "AI"
                        },
                        new
                        {
                            id = new Guid("533c18b0-7409-43c1-aa5d-86ec21dfd47b"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5900),
                            Name = "Software"
                        },
                        new
                        {
                            id = new Guid("659ee72b-10de-4c8c-9424-b2cc1f3a0816"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5926),
                            Name = "Hardware"
                        },
                        new
                        {
                            id = new Guid("0ca221ab-a251-4f22-abad-5c9244ae76c0"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5931),
                            Name = "Network"
                        });
                });
            ...
            modelBuilder.Entity("Models.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("2a89570e-7c0c-42ef-b5e1-da5909c7e4fe"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5757),
                            Password = "as6d4",
                            Username = "CSEroshd",
            ...
            modelBuilder.Entity("Models.Models.Professor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("c5fc2e06-f57f-49b9-8a16-362af4bf0e1b"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5808),
                            Password = "51324342",
                            Username = "Dr.vahidi",
            ...
            modelBuilder.Entity("Models.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("ce58a55c-81a5-48c4-9c1a-a4c26f9f9b0c"),
                            CreateTime = new DateTime(2022, 7, 28, 23, 56, 21, 132, DateTimeKind.Local).AddTicks(5509),
                            Password = "324reza",
                            Username = "RezaKlhor",
