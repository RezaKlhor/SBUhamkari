...
namespace SBUhamkari.Migrations
{
    ...
    [Migration("20220722092808_InitialCre")]
            ...
            modelBuilder.Entity("Models.Models.EducationInstitute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("92f2070b-defe-4477-b381-5b52f686e408"),
                            CreateTime = new DateTime(2022, 7, 22, 13, 58, 8, 19, DateTimeKind.Local).AddTicks(1854),
                            Name = "SBU"
                        });
                });
            ...
            modelBuilder.Entity("Models.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("65eefde7-1b06-44dd-b9eb-7c7dda9f6e09"),
                            CreateTime = new DateTime(2022, 7, 22, 13, 58, 8, 19, DateTimeKind.Local).AddTicks(2282),
                            Password = "as6d4",
                            Username = "CSEroshd",
            ...
            modelBuilder.Entity("Models.Models.Professor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("37c5427f-bf18-4835-b80b-d68649fe0f06"),
                            CreateTime = new DateTime(2022, 7, 22, 13, 58, 8, 19, DateTimeKind.Local).AddTicks(2328),
                            Password = "51324342",
                            Username = "Dr.vahidi",
            ...
            modelBuilder.Entity("Models.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("101bbe1a-79b1-46ce-8877-5de93e666675"),
                            CreateTime = new DateTime(2022, 7, 22, 13, 58, 8, 19, DateTimeKind.Local).AddTicks(2042),
                            Password = "324reza",
                            Username = "RezaKlhor",
