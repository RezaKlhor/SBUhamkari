...
namespace SBUhamkari.Migrations
{
    ...
    [Migration("20220728214616_init19")]
            ...
            modelBuilder.Entity("Models.Models.EducationInstitute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("6902dbda-13e2-4ed4-83d4-cf1058fecb84"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 16, 16, 28, DateTimeKind.Local).AddTicks(1730),
                            Name = "SBU"
                        },
                        new
                        {
                            id = new Guid("05444025-83e0-4cb2-b458-b55bc50eac11"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 16, 16, 28, DateTimeKind.Local).AddTicks(1807),
                            Name = "PNU"
                        });
                });
            ...
            modelBuilder.Entity("Models.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("2b73a823-5b08-4a35-848b-c21abcb806b7"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 16, 16, 28, DateTimeKind.Local).AddTicks(1877),
                            Name = "Admin"
                        },
                        new
                        {
                            id = new Guid("77b3b07c-3038-4de0-8905-933d4675c456"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 16, 16, 28, DateTimeKind.Local).AddTicks(1889),
                            Name = "Student"
                        },
                        new
                        {
                            id = new Guid("3129ee82-8693-40b9-9227-ab7cf830775c"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 16, 16, 28, DateTimeKind.Local).AddTicks(1894),
                            Name = "teacher"
                        },
                        new
                        {
                            id = new Guid("b82fc0bf-89d9-40d8-9886-793e6d52bbad"),
                            CreateTime = new DateTime(2022, 7, 29, 2, 16, 16, 28, DateTimeKind.Local).AddTicks(1907),
                            Name = "Company"
                        });
                });
